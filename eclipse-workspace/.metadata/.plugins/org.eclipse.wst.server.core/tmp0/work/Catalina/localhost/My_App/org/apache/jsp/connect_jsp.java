 ...
 * Generated at: 2023-07-06 16:37:23 UTC
...
PreparedStatement ps=con.prepareStatement("insert into registration(fname,lname,gender,email,phone,pwd) values('"+fname+"','"+lname+"','"+gender+"','"+email+"','"+phone+"','"+pwd+"')");
